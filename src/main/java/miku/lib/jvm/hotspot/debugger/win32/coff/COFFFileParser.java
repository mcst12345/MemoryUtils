...
import miku.lib.jvm.hotspot.debugger.DataSource;
import miku.lib.jvm.hotspot.debugger.MappedByteBufferDataSource;
import miku.lib.jvm.hotspot.utilities.memo.MemoizedObject;
...
COFFFile} objects. This class is a
 singleton. */
    ...
    class COFFFileImpl implements COFFFile {
        ...
        class COFFHeaderImpl implements COFFHeader {
            ...
            class DebugVC50Impl implements DebugVC50, DebugVC50TypeLeafIndices {
                ...
                class DebugVC50SubsectionDirectoryImpl
                    ...
                    public DebugVC50Subsection getSubsection(int i) {
                        ...
                        seek(offset + dirHeaderLength + ((long) i * dirEntryLength));
                ...
                class DebugVC50SSSrcModuleImpl extends DebugVC50SubsectionImpl implements DebugVC50SSSrcModule {
                    ...
                    DebugVC50SSSrcModuleImpl(short ssType, short iMod, int ssSize, final int offset) {
                        ...
                        segOffsets = new MemoizedObject() {
                            public Object computeValue() {
                                seek(offset + 4L * (getNumSourceFiles() + 1));
                        ...
                        segs = new MemoizedObject() {
                            public Object computeValue() {
                                seek(offset + 4L * (getNumSourceFiles() + 1) + 8L * getNumCodeSegments());
                ...
                class DebugVC50SrcModFileDescImpl implements DebugVC50SrcModFileDesc {
                    ...
                    DebugVC50SrcModFileDescImpl(final int offset, final int baseOffset) {
                        ...
                        segOffsets = new MemoizedObject() {
                            public Object computeValue() {
                                seek(offset + 4L * (getNumCodeSegments() + 1));
                                int[] res = new int[2 * getNumCodeSegments()];
                                for (int i = 0; i < 2 * getNumCodeSegments(); i++) {
                                    res[i] = readInt();
                                }
                        ...
                        name = new MemoizedObject() {
                            public Object computeValue() {
                                seek(offset + 4 + 12L * getNumCodeSegments());
                ...
                class DebugVC50SrcModLineNumberMapImpl implements DebugVC50SrcModLineNumberMap {
                    ...
                    DebugVC50SrcModLineNumberMapImpl(final int offset) {
                        ...
                        lineNumbers = new MemoizedObject() {
                            public Object computeValue() {
                                seek(offset + 4L * (getNumSourceLinePairs() + 1));
                ...
                class DebugVC50SymbolIteratorImpl implements DebugVC50SymbolIterator {
                    ...
                    public void advanceToEntryThisSymbol() {
                        ...
                        if(!(pos + curSymSize + 2 == pos + 4 + tmpSymSize)){
                            throw new IllegalStateException("advanceToEntryThisSymbol needs more work");
                        }
                        pos += 4;
                    ...
                    public int getLGProcEndOffset() {
                        ...
                        int offs = readInt();
                        if(offs == 0){
                            throw new IllegalStateException("should not have null end offset for procedure symbols");
                        }
                        return base + offs;
                    }
                    ...
                    public int getThunkEndOffset() {
                        ...
                        int offs = readInt();
                        if(offs == 0){
                            throw new IllegalStateException("should not have null end offset for thunk symbols");
                        }
                        return base + offs;
                    }
                    ...
                    public int getBlockEndOffset() {
                        ...
                        int offs = readInt();
                        if(offs == 0){
                            throw new IllegalStateException("should not have null end offset for block symbols");
                        }
                        return base + offs;
                    }
            ...
            class SectionHeaderImpl implements SectionHeader {
                ...
                public  SectionHeaderImpl(int offset) throws COFFException {
                    ...
                    if (tmpName[0] == (byte) '/') {
                        ...
                        int index;
                        try {
                            index = Integer.parseInt(new String(tmpName, 1, tmpName.length - 1, StandardCharsets.US_ASCII));
                        ...
                        name = new String(tmpName, 0, length, StandardCharsets.US_ASCII);
                    }
                    virtualSize          = readInt();
            ...
            class AuxFileRecordImpl implements AuxFileRecord {
                ...
                AuxFileRecordImpl(int offset) {
                    ...
                    name = new String(tmpName, StandardCharsets.US_ASCII);
                }
            ...
            class StringTable {
                ...
                StringTable(int offset) {
                    ...
                    for (int i = 0; i < numStrings; i++) {
                        ...
                        strings[i] = new COFFString(new String(data, lastPtr, ptr - lastPtr, StandardCharsets.US_ASCII),
                                offset + ptr + 4);
                        ptr++;
                        lastPtr = ptr;
                    }
                ...
                String getAtOffset(int offset) {
                    int i = Arrays.binarySearch(strings, new COFFString(null, offset),
                            (Comparator) (o1, o2) -> {
                                ...
                                return Integer.compare(s1.offset, s2.offset);
                            });
                    if (i < 0) {
        ...
        byte readByte() throws COFFException {
            try {
                ...
                throw new COFFException(e + " at offset 0x" +
