...
public class DumpExports {
    ...
    public static void main(String[] args) {
        if (args.length != 1) {
            args = new String[]{"C:\\Program Files\\OpenLogic\\jdk-8.0.402.06-hotspot\\jre\\bin\\server\\jvm.dll"};
            //usage();
        }
        ...
        if (exports == null) {
            ...
            System.out.println("Major version 0x" + Integer.toHexString(exports.getMajorVersion() & '\uffff'));
            System.out.println("Minor version 0x" + Integer.toHexString(exports.getMinorVersion() & '\uffff'));
