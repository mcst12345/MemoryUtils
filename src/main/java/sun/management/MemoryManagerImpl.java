 ...
 */
public class MemoryManagerImpl extends NotificationEmitterSupport
        implements MemoryManagerMXBean {

    public String name;
    public boolean isValid;
    public MemoryPoolMXBean[] pools;
    public MBeanNotificationInfo[] notifInfo = null;
    ...
    public synchronized MemoryPoolMXBean[] getMemoryPools() {
        if (pools == null) {
    ...
    public native MemoryPoolMXBean[] getMemoryPools0();
