...
public class InstrumentationImpl implements Instrumentation {
    ...
    public TransformerManager mTransformerManager;
    public TransformerManager mRetransfomableTransformerManager;
    // needs to store a native pointer, so use 64 bits
    public long mNativeAgent;
    public boolean mEnvironmentSupportsRedefineClasses;
    public volatile boolean mEnvironmentSupportsRetransformClassesKnown;
    public volatile boolean mEnvironmentSupportsRetransformClasses;
    public boolean mEnvironmentSupportsNativeMethodPrefix;

    public InstrumentationImpl(long nativeAgent,
