...
class Thread implements Runnable {
    ...
    public static volatile UncaughtExceptionHandler defaultUncaughtExceptionHandler;

    static {
        registerNatives();
    }

    public final Object blockerLock = new Object();
    public volatile String name;
    public int priority;
    public Thread threadQ;
    public long eetop;
    ...
    /* JVM state */
    public boolean stillborn = false;
    /* What will be run. */
    ...
    /*
     * JVM-public state that persists after native thread termination.
     */
    public long nativeParkEventPointer;
    /*
     * Thread ID
     */
    public long tid;
     ...
     */
    public volatile Interruptible blocker;
    // null unless explicitly set
    public volatile UncaughtExceptionHandler uncaughtExceptionHandler;
     ...
     * Set by (public) java.util.concurrent.locks.LockSupport.setBlocker
     ...
     */
    public static boolean isCCLOverridden(Class<?> cl) {
        if (cl == Thread.class)
            return false;
     ...
     */
    public static boolean auditSubclass(final Class<?> subcl) {
    ...
    public native static StackTraceElement[][] dumpThreads(Thread[] threads);

    public native static Thread[] getThreads();
     ...
     */
    public void init(ThreadGroup g, Runnable target, String name,
                     long stackSize) {
    ...
    public native void setPriority0(int newPriority);
    ...
    public native void stop0(Object o);

    public native void suspend0();

    public native void resume0();

    public native void interrupt0();

    public native void setNativeName(String name);
