...
class SecurityManager {
    ...
    public static ThreadGroup rootGroup = getRootGroup();
    /*
     ...
     * the cache.
     */
    public static boolean packageAccessValid = false;
    public static String[] packageAccess;
    public static Object packageAccessLock = new Object();
    public static boolean packageDefinitionValid = false;
    public static String[] packageDefinition;
    public static Object packageDefinitionLock = new Object();
    /**
    ...
    public static String[] getPackages(String p) {
    ...
    public native ClassLoader currentClassLoader0();
     ...
     */
    @Deprecated
    public native int classDepth(String name);
    ...
    public native int classLoaderDepth0();
    ...
    public native Class<?> currentLoadedClass0();
