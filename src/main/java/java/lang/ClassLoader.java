...
public abstract class ClassLoader {
    ...
    public static final Certificate[] nocerts = new Certificate[0];
    // The class loader for the system
    // @GuardedBy("ClassLoader.class")
    public static ClassLoader scl;
    // Set to true once the system class loader has been set
    // @GuardedBy("ClassLoader.class")
    public static boolean sclSet;
    // All native library names we've loaded.
    public static Vector<String> loadedLibraryNames = new Vector<>();
    // Native libraries belonging to system classes.
    public static Vector<NativeLibrary> systemNativeLibraries
            = new Vector<>();
    // native libraries being loaded/unloaded.
    public static Stack<NativeLibrary> nativeLibraryContext = new Stack<>();
    // The paths searched for libraries
    public static String usr_paths[];
    public static String sys_paths[];
    ...
    public final ConcurrentHashMap<String, Object> parallelLockMap;
    // Hashtable that maps packages to certs
    public final Map<String, Certificate[]> package2certs;
    // The classes loaded by this class loader. The only purpose of this table
    // is to keep the classes from being GC'ed until the loader is GC'ed.
    public final Vector<Class<?>> classes = new Vector<>();
    // The "default" domain. Set as the default ProtectionDomain on newly
    // created classes.
    public final ProtectionDomain defaultDomain =
    ...
    public Vector<NativeLibrary> nativeLibraries = new Vector<>();
    // The default toggle for assertion checking.
    // @GuardedBy("assertionLock")
    public boolean defaultAssertionStatus = false;
    ...
    // been invoked.
    // @GuardedBy("assertionLock")
    public Map<String, Boolean> packageAssertionStatus = null;
     ...
     * Find resources from the VM's built-in classloader.
     */
    public static Enumeration<URL> getBootstrapResources(String name)
            throws IOException {
    ...
    public static synchronized void initSystemClassLoader() {
        if (!sclSet) {
            if (scl != null)
    ...
    // any class loader.
    public static boolean needsClassLoaderPermissionCheck(ClassLoader from,
                                                          ClassLoader to) {
        if (from == to)
            return false;
    ...
    static ClassLoader getClassLoader(Class<?> caller) {
        ...
        // Circumvent security check since this is package-public
    ...
    public static String[] initializePath(String propname) {
    ...
    public static void loadLibrary(Class<?> fromClass, String name,
                                   boolean isAbsolute) {
        ClassLoader loader =
    ...
    public static boolean loadLibrary0(Class<?> fromClass, final File file) {
    ...
    public static native AssertionStatusDirectives retrieveDirectives();
    ...
    public Class<?> loadClassInternal(String name)
            throws ClassNotFoundException {
    ...
    public void checkPackageAccess(Class<?> cls, ProtectionDomain pd) {
     ...
     */
    @Deprecated
    public final Class<?> defineClass(byte[] b, int off, int len)
    ...
    /* Determine protection domain, and check that:
        ...
        - signer of this class matches signers for the rest of the classes in
          package.
    */
    public ProtectionDomain preDefineClass(String name,
                                           ProtectionDomain pd) {
        if (!checkName(name))
    ...
    public String defineClassSourceLocation(ProtectionDomain pd) {
    ...
    public void postDefineClass(Class<?> c, ProtectionDomain pd) {
     ...
     * @since 1.5
     */
    public final Class<?> defineClass(String name, java.nio.ByteBuffer b,
                                      ProtectionDomain protectionDomain)
            throws ClassFormatError {
        int len = b.remaining();
    ...
    public native Class<?> defineClass1(String name, byte[] b, int off, int len,
                                        ProtectionDomain pd, String source);

    public native Class<?> defineClass2(String name, java.nio.ByteBuffer b,
    ...
    public void checkCerts(String name, CodeSource cs) {
     ...
     */
    public boolean compareCerts(Certificate[] pcerts,
                                Certificate[] certs) {
    ...
    public native void resolveClass0(Class<?> c);
     ...
     * @see #getParent()
     */
    public final Class<?> findSystemClass(String name)
            throws ClassNotFoundException {
        ClassLoader system = getSystemClassLoader();
        if (system == null) {
            if (!checkName(name))
    ...
    public native Class<?> findBootstrapClass(String name);
    ...
    public native final Class<?> findLoadedClass0(String name);
     ...
     * @since 1.1
     */
    public final void setSigners(Class<?> c, Object[] signers) {
    ...
    public static class ParallelLoaders {
        ...
        public static final Set<Class<? extends ClassLoader>> loaderTypes =
     ...
     * public field <tt>nativeLibraries</tt>.  The native libraries loaded
     * into the system are entered into the <tt>systemNativeLibraries</tt>
     * vector.
     *
     * <p> Every native library requires a particular version of JNI. This is
     * denoted by the public <tt>jniVersion</tt> field.  This field is set by
    ...
    public static class NativeLibrary {
        ...
        public native void unload(String name, boolean isBuiltin);
