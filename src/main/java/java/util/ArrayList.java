...
public class ArrayList<E> extends AbstractList<E>
     ...
     */
    public transient Object[] elementData; // non-public to simplify nested class access
    /**
    ...
    static final class ArrayListSpliterator<E> implements Spliterator<E> {
        ...
        public int fence; // -1 until used; then one past last index
        public int expectedModCount; // initialized when fence set
        ...
        public int getFence() { // initialize fence to size on first use
